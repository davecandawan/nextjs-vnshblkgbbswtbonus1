...
const Slideshow: React.FC = () => {
  ...
  const slides = [
    {
      image: '/contentimages/VNSH_Black_Holster_Top_Hero.webp',
      alt: 'Hero slide',
    },
    {
    ...
    },
    {
      ...
      alt: 'Black Holster Image 3',
    },
    {
      image: '/contentimages/VNSH_Black_Holster_Top_Hero4.webp',
      alt: 'Black Holster Image 4',
    },
    {
      image: '/contentimages/VNSH_Black_Holster_Top_Hero3.webp',
      alt: 'Black Holster Image 5',
    },
    {
      image: '/contentimages/VNSH_Black_Holster_Top_Hero6.webp',
      alt: 'Black Holster Image 6',
    },
  ];
